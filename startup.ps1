...
Write-Host "=========================================================="
Write-Host "🔗 IMPORTANT URLS & PORTS"
Write-Host "=========================================================="
...
Write-Host "=========================================================="
Write-Host "`nNote: Python services (FastAPI, CDC, Processor, Ledger) have been opened in separate console windows so you can monitor their logs independently."
